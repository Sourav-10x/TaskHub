...
describe("Layout Elements of Landing Page", () => {
  describe("Rendering", () => {
    it("should have a Navbar component with logo and 2 buttons", () => {
      ...
      expect(screen.getByTestId("logo")).toHaveTextContent("TaskHub");
      ...
      expect(
        screen.getByTestId("navbar_get_TaskHub_button")
      ).toBeInTheDocument();
      expect(screen.getByTestId("navbar_get_TaskHub_button")).toHaveTextContent(
        "Get TaskHub for free"
      );
      expect(
        screen.getByTestId("navbar_get_TaskHub_button").closest("a")
