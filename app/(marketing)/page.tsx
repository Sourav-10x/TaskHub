  ...
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      >
        ...
        >
          TaskHub helps team move
        </h1>
        <div
          className="text-3xl md:text-6xl bg-gradient-to-r from-pink-600 to-blue-600 text-white px-4 p-2 rounded-md pb-4 w-fit"
      ...
      >
        ...
        accomplish it all with TaskHub.
      </div>
